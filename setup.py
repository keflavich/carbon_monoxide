...
PACKAGENAME = metadata.get('package_name', 'carbon_monoxide')
DESCRIPTION = metadata.get('description', 'carbon monoxide')
AUTHOR = metadata.get('author', 'Adam Ginsburg')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: carbon_monoxide requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
